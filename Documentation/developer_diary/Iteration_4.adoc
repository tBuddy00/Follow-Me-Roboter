...
== Iterationen
=== 4. Iteration 20.12.2023 - 03.01.2024 
=== Allgemein
==== Standerfassung aus 3. Iteration

Mit Beginn unserer 4. Iteration (20.12.2023 - 03.01.2024) erreichten wir einen Meilenstein: Unser erster vollfunktionsfähiger Prototyp ist in Betrieb genommen und durch unseren Auftraggeber Herr Prof. Neugebauer abgesegnet worden. Wir führen demnach einen Punkt insbesondere fort: Vervollständigung unserer Belegabeit und die darin enthaltenen Dokumente. 
...
==== Zielstellung zur 4. Iteration
Unsere **Zielstellung für die 4. Iteration** vom Zeitraum 20.12.2023 - 03.01.2024 haben wir folgende Punkte in unser Augenmerk genommen:

- 1. Vervollständigung unserer Belegarbeit: Risk-List, Architecture Notebook etc.
