...
- Programmteile von ROS I in ROS II übersetzen -> Wer? (Claire steht für Fragen offen),
...
- Bessere Debug Tools (Claire bei Fragen),
...
(Sofern hier nicht aufgeführt, dann bereits o. g.)
