...
=== Teamstruktur zur 3. Iteration (04.12.2023 - 18.12.2023)
...
**Hallo Theresa: Bitte ergänze ab hier den Stand mit dem wir aus der 2. Iteration kommen und in die 3. Iteration hineingehen**
...
**Alles unter diesem Punkt darf auch ergänzt werden und auf die 3. Iteration angepasst werden**
...
**Bitte auch unter diesem Punkt alles ergänzen**

=== Gruppenmeeting mit Projekt-Coach am 05.12.2023
==== Anlass 
