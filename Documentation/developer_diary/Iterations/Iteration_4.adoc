...
Mit Beginn unserer 4. Iteration (20.12.2023 - 03.01.2024) erreichten wir einen Meilenstein: Unser erster vollfunktionsfähiger Prototyp ist in Betrieb genommen und durch unseren Auftraggeber Herr Prof. Neugebauer abgesegnet worden. 
