...
=== Teamstruktur zur 10. Iteration (10.05.2024 - 24.05.2024)
...
=== *10. Iteration 10.05.2024 - 24.05.2024*
=== Allgemein
==== Standerfassung aus 9. Iteration

Mit der 8. Iteration begann weiterhin die Weiterführung der Arbeit aus der 9 Iteration und so gilt weiterhin u. a. die Verbesserung der Bilderkennung und die Vervollständigung des Belegs.
...
=== Coach-Meeting 22.05.2024 
include::../Besprechungsprotokoll/Besprechung_22.05.2024.adoc[]
//end::Iter10[]