...
=== Teamstruktur zur 9. Iteration (25.04.2024 - 09.05.2024)
...
=== *9. Iteration 25.04.2024 - 09.05.2024*
=== Allgemein
==== Standerfassung aus 8. Iteration
...
=== Gruppenmeeting 06.05.2024 
include::../Besprechungsprotokoll/Besprechung_06.05.2024.adoc[]
//end::Iter9[]