...
=== Teamstruktur der 1. bis 5. Iteration (06.11.2023 - 03.01.2024)
...
=== Teamstruktur der 6. bis 9. Iteration (11.03.2024 - 09.04.2024)
|===
|Team |Teambeschreibung |Teammitglieder
|**Entwicklungs Team I**
|Entwicklungsteam I unter Leitung von Herr Marthaus ist zu Beginn der 1. Iteration (06.11.2023 - 19.11.2023) für die Bilderkennung des Fahrroboters zuständig.
...
== Iterationen
include::Iteration_1.adoc[tags=Iter1]

include::Iteration_2.adoc[tags=Iter2]

include::Iteration_3.adoc[tags=Iter3]

include::Iteration_4.adoc[tags=Iter4]

include::Iteration_5.adoc[tags=Iter5]

include::Iteration_6.adoc[tags=Iter6]

include::Iteration_7.adoc[tags=Iter7]

include::Iteration_8.adoc[tags=Iter8]

include::Iteration_9.adoc[tags=Iter9]
