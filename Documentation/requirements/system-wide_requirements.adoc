...
- *NFAP-2:* Der Alphabot 2 muss i. S. d. Datendurchsatzes in der Lage sein innerhalb von 60 Sekunden eine korrekte Antwort zur Bilderkennung zu liefern.
...
- *NFAP-4:* Der Alphabot 2 samt Software muss in der Lage dazu sein innerhalb von 10 Minuten zu starten und innerhalb von 1 Minute sich vollständig sich zu beenden.
