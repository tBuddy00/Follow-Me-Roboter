...
- *NFAU-1:* Die Bedienung des Alphabot soll leicht und ohne Vorkenntnisse möglich sein.
...
- *NFAP-4:* Der Alphabot 2 samt Software muss in der Lage dazu sein, innerhalb von 10 Minuten zu starten und innerhalb von 1 Minute sich vollständig zu beenden.
