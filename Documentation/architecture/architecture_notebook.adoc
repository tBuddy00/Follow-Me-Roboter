...
Wir entschieden uns für das OS ROS II aufgunddessen das dies vom Auftraggeber Herr Prof. Neugebauer empfohlen wurde und dies Komponenten mit sich bringt, die durchaus essenziell für das Projekt bzw. den Alphabot 2 sind.
