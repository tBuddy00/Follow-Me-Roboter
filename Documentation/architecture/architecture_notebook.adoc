...
Unsere Philosophie besteht in diesem Projekt im allgemeinen darin, dass wir das bestmögliche Ergebnis in gegebener Zeit herausholen und das Projekt so modular wie nur möglich zu gestalten. Übersichtlichkeit und Erweiterbarkeit war unser großes Ziel.

Des Weiteren entsprach unsere Teamphilosophie dem Ansatz aufkommende Aufgaben so schnellst und bestmöglich für die jeweilige Iteration zu erledigen und demnach einen ersten Prototypen vollfunktionsfähig zu produzieren bzw. zu entwickeln.
...
Nach aktuellen Gesichtspunkten nutzen wir Ubuntu 22.04, welches das von ROS II Humble Dokumentation verlangte Betriebssystem darstellt.
