...
Unser Architektur-Framework ist durch ros2 gegeben. https://automaticaddison.com/ros-2-architecture-overview/

als middleware  verwendet Ros2 dabei die Data Distribution Service (DDS) Architektur. 

darauf baut dan der Ros2 Client Layer auf, welcher die bibliothecken für die verwendung von Ros zur verfügung stelt. 

und zuletzt ist dan der Application Layer, welcher die eigentliche anwendung enthält.
