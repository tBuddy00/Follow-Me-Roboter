...
[discrete]
==== *Bilderfassung und Bildvorverarbeitung*
...
=== Roboter
- **Hardwareebene**: Raspberry Pi, Alphabot 2, Arduino Uno, 
...
Unser Architektur-Framework wird durch die Verwendung von ROSII vorgegeben.

Als Middleware verwendet ROSII dabei die Data Distribution Service (link:https://automaticaddison.com/ros-2-architecture-overview/[DDS) Architektur]. 

Darauf baut dann der ROSII Client-Layer auf, welcher die Bibliotheken für die Verwendung von ROS zur Verfügung stelt. 
...
- **Use Cases**: Eine Liste oder ein Diagramm der Use Cases, die architektur-relevante Anforderungen enthalten. https://github.com/tBuddy00/Follow-Me-Roboter/blob/main/Documentation/requirements/use-case_model.adoc[Hier klicken: Use Cases]
