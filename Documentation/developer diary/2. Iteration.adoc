...
==== Anlass 
Der Anlass für dieses außerplanmäßge Gruppenmeeting war, dass sich auf Geheiß von Teamleiter für das Entwicklerteam II Herr Marthaus eine nicht ausreichende Zuarbeit von einigen Teammitgliedern aus seinem Team war.
