...
|**Claire Schuster, Wirtschaftsinformatik** | Frau Schuster übernimmt zu Ihrer Tätigkeit als **stellvertretende Projektleitung** ebenfalls die Rolle als **Creative Lead** und **Architect**. Sie teilt des Weiteren Aufgaben den anderen Teammitgliedern zu und dient als Ansprechperson im technischen Zusammenhang mit dem Fahrroboter. 
...
| **Luca Kurth, Verwaltungsinformatik** | Herr Kurth trägt die Rolle als **Entwickler** und trägt mit zur Entwicklung des Fahrroboters bei.
|===
...
=== Teamstruktur zur 2. Iteration (20.11.2023 - 04.12.2023)
...
Mit Beginn unserer 2. Iteration mit dem Zeitraum vom 20.11.2023 - 04.12.2023 hielten wir zeitnah am 21.11.2023 (Dienstag) ein Gruppenmeeting zur Erfassung unserer aktuellen Projektstruktur ab und berieten uns auch um Allgemeinheiten. 
 ...
 - **Zweiter Punkt:** ROS II wird als OS für unseren Rasberry Pi festgelegt und implementiert durch Frau Claire Schuster und die Dokumentation zur Implementierung führt Herr Danny Miersch.
...
- 1. Wir wollen alle Roboterfunktionen im Sinne der Ansprechbarkeit der einzelnen Glieder ansprechen und ROS II implementieren -> wie o. g. übernimmt Frau Claire Schuster beide genannten Ziele.
