...
image:..Bilderkennung_Konzept.drawio[]

*Hinweis:*
 Das Bilderkennungskonzept wurde durch Frau Schuster entwickelt und durch unseren Auftraggeber in unserem ersten Auftraggebergespräch am 17.11.2023 bestätigt.
