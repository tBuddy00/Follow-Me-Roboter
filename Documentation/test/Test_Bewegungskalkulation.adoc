:test-images: Movement_calculation_test
...
image::{test-images}/connect_bluetooth.png[]

- Dann muss der COM-Port des Arduinos ermittelt werden, beispielsweise mittels der Arduino IDE.

image::{test-images}/arduino_ide_find_out_com_port_1.png[]

- Testen der Connection mit dem Serial Monitor.

image::{test-images}/arduino_ide_find_out_com_port_2.png[]
...
image::{test-images}/test_stage_2.png[]

image::{test-images}/Measure_angle.png[]
...
image::{test-images}/Test_movement_Calculation.PNG[]