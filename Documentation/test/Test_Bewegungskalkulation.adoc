...
image::Documentation/test/Movement_calculation_test/arduino_ide_find_out_com_port_1.png[]

- Dann Testen der Connection mit dem Serial Monitor.

image::Documentation/test/Movement_calculation_test/arduino_ide_find_out_com_port_2.png[]
