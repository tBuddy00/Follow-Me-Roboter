// --- 1. Projektthema -------------------------
= SE I - Belegabgabe: Follow-Me Fahrroboter
// --- 2. Teammitglieder -----------------------
Taylan Özer s85500@htw-dresden.de; Claire Schubert s85609@htw-dresden.de; Theresa Stasch s82413@htw-dresden.de; Johann Marthaus s85567@htw-dresden.de; Jonathan Palermo s85287@htw-dresden.de; Danny Miersch s85567@htw-dresden.de; Jeremy Ziegert s85299@htw-dresden.de; Luca Kurth s85449@htw-dresden.de
// --- 3. Abgabedatum --------------------------
26. Januar 2024
// ---------------------------------------------
:docs: ../Documentation
...
:imagesdir: {developer-diary}/images

//1. Iteration
include::{docs-developer-diary}/Iteration_1.adoc[lines=1..1;4..-1,leveloffset=+1]
<<<
//2. Iteration
include::{docs-developer-diary}/Iteration_2.adoc[lines=1..1;4..-1,leveloffset=+1]
<<<
3. Iteration
include::{docs-developer-diary}/Iteration_3.adoc[lines=1..1;4..-1,leveloffset=+1]
<<<
4. Iteration
include::{docs-developer-diary}/Iteration_4.adoc[lines=1..1;4..-1,leveloffset=+1]
<<<
5. Iteration
include::{docs-developer-diary}/Iteration_5.adoc[lines=1..1;4..-1,leveloffset=+1]
<<<
...
* Test Cases (noch nicht formuliert -> in SE II)
* Design
